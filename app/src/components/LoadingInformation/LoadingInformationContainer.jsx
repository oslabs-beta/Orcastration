...
export default function LoadingInformation({ currentStep, setCurrentStep }) {
  ...
  const loadingProgress = {
    ...
    Ready: (
      <button
        onClick={handleClick}
        className='bg-nightblue-300 rounded-md p-2 text-lg text-slate-100 animate-pulse transition ease-in-out duration-300 hover:bg-custompurple'
      >
        Start Streaming
      </button>
    ),
  ...
  return (
    <div className='bg-slate-100/90 mx-4 rounded-md h-1/5 text-slate-900 flex items-center justify-center text-center px-4'>
